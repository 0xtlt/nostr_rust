...
impl Client {
    ...
    /// }
    ///
    /// tokio::runtime::Runtime::new().unwrap().block_on(test_react_to());
    /// ```
    ...
    /// }
    ///
    /// tokio::runtime::Runtime::new().unwrap().block_on(test_like());
    /// ```
    pub async fn like(
        &mut self,
        identity: &Identity,
    ...
    /// }
    ///
    /// tokio::runtime::Runtime::new().unwrap().block_on(test_dislike());
    /// ```
