...
/// }
///
/// tokio::runtime::Runtime::new().unwrap().block_on(test_check_validity());
/// ```
...
/// }
///
/// tokio::runtime::Runtime::new().unwrap().block_on(test_get_nips05());
/// ```
...
/// }
///
/// tokio::runtime::Runtime::new().unwrap().block_on(test_get_nip05());
/// ```
