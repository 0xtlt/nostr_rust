...
/// # Example
/// ```
/// use nostr_rust::utils::keys::get_random_secret_key;
...
/// # Example
/// ```rust
/// use nostr_rust::utils::keys::secret_key_from_str;
...
/// # Example
/// ```rust
/// use nostr_rust::utils::keys::{secret_key_from_str, get_public_key_from_secret};
///
...
/// # Example
/// ```rust
/// use nostr_rust::utils::keys::{secret_key_from_str, get_str_keys_from_secret};
///
/// let secret_key = secret_key_from_str(env!("SECRET_KEY")).unwrap();
