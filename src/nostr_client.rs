...
impl Client {
    ...
    /// }
    ///
    /// tokio::runtime::Runtime::new().unwrap().block_on(test_add_relay());
    /// ```
    ...
    /// }
    ///
    /// tokio::runtime::Runtime::new().unwrap().block_on(test_remove_relay());
    /// ```
    ...
    /// }
    ///
    /// tokio::runtime::Runtime::new().unwrap().block_on(test_subscribe());
    /// ```
    ...
    /// }
    ///
    /// tokio::runtime::Runtime::new().unwrap().block_on(test_subscribe_with_id());
    /// ```
    ...
    /// }
    ///
    /// tokio::runtime::Runtime::new().unwrap().block_on(test_unsubscribe());
    /// ```
    ...
    /// }
    ///
    /// tokio::runtime::Runtime::new().unwrap().block_on(test_get_events_of());
    /// ```
